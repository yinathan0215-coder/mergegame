...
//
// Companion rule injected:  .claude/rules/docs-auto-reflect.md
// Companion pipeline:        .claude/rules/docs-pipeline.md
...
function main() {
  ...
  const projectDir =
    process.env.CLAUDE_PROJECT_DIR || hook.cwd || process.cwd();
  ...
  const out =
    ...
    `At the end of each turn, follow this rule (canonical: .claude/rules/docs-auto-reflect.md). ` +
