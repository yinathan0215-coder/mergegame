...
### Stage Clear
- **등장:** 목표 달성 **2초 뒤**(대기 중 **화면 탭 시 즉시**), 전환 효과와 함께 클리어 결과창이 뜬다(보상 **코인 +300** 지급 후).
...
### 공통
- **Stage 클리어/실패**는 종료 후 **2초 지연** 등장(수치 [[../40-balancing/game-modes]]); **Infinite
  결과**는 카운트 소진 + 모든 행성 정지 후 즉시 등장(고정 지연 없음).
