...
발사대는 **현재 발사 행성 하나**를 보여준다. 발사하면 **낮은 5종**에서 균등 랜덤으로 뽑은 새 행성이
발사대에 로드된다.
...
- **후보(낮은 5종):** **수성 · 화성 · 금성 · 지구 · 해왕성** 균등 추출. 균등 확률 값의 SSoT는
  [[40-balancing/index]] (각 20%).
- **상위 등급 등장:** **천왕성 · 토성 · 목성 · 태양**은 합성으로 등장한다.
