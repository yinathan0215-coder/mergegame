...
function main() {
  ...
  const ctx = [
    ...
    `docs/ is the agent-executable 기획문서 (GDD) and living source of truth. Before acting on anything design / content / implementation related, follow .claude/rules/docs-pipeline.md:`,
