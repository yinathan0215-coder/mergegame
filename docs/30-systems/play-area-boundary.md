...
보드의 **충돌 경계는 inner line**(방패형 보드 윤곽: 둥근 직사각형 + 140° 테이퍼 + 하단 호)과
**발사대 원형 공간**이다. 행성은 inner line과 발사대 원에 부딪혀 보드 안에 머문다.
...
- **발사 일방향(발사대 원 예외):** 갓 발사된 행성은 발사대 원과 충돌하지 않고 **밖으로 한 번 빠져나간다**.
