...
import { LAUNCHER } from './data/config';

// First-launch coach (docs/50-art-ux/input-ux §첫 제스처 코치): on entering Pool In-Game, a 👆 finger
// repeatedly presses at the launch planet and drags DOWN ("press & pull back to launch"), looping until
// the player starts aiming (hidden while aiming) and gone for good after the first launch. Render-only.
...
export class FirstGestureHint {
  ...
  constructor(layer: Container) {
    ...
    this.container.addChild(this.finger, this.hint);
