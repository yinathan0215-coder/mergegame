...
코인은 게임의 **소프트 화폐**다. 미션·출석·돌림판으로 벌고, 돌림판 회전(1회 100)에 쓴다.
...
- **시작 잔액 = 0.** 신규 플레이어는 코인 0으로 시작한다([[../40-balancing/meta-economy]]
  `economy.startCoins`). Title 로비 상단에 현재 잔액이 코인 아이콘과 함께 표시되며,
  **Pool In-Game에서도 같은 위치(왼쪽 상단)에 동일 컴포넌트로 표시**된다([[../50-art-ux/title-screen]] · [[../50-art-ux/layout]]).
- **획득:** 미션 달성(개당 50 + 누적 마일스톤 50/100/200), 출석(일차별 100~400), 돌림판(10~250).
- **소비:** 행운의 돌림판 1회 회전 = 100 코인([[lucky-wheel]]). 상점은 잠금이라 코인 소비처가 아니다([[shop]]).
